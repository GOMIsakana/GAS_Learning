...
<SubTitle>左零右火, 雷公助我!</>\n\
<Warning>[此技能需要选中一个目标]</>\n\
		<Default>激活时, 对目标持续造成伤害, 每秒造成</> <Damage>%.1f</> <Default>点</><LightingDamage>雷属性伤害</>\n\
		<Default>在技能结束时, 对目标额外造成</> <Damage>%.1f</> <Default>点</><LightingDamage>雷属性伤害</><Default>, 并<LightingDamage>击晕</>目标 %.2f 秒</>\n\n\
...
<SubTitle>左零右火, 雷公助我!</>\n\
<Warning>[此技能需要选中一个目标]</>\n\
		<Default>激活时, 对目标以及目标周围 %.0f 范围内的至多 %d 名敌人持续造成伤害, 每秒造成</> <Damage>%.1f</> <Default>点</><LightingDamage>雷属性伤害</>\n\
		<Default>在技能结束时, 对所有目标额外造成</> <Damage>%.1f</> <Default>点</><LightingDamage>雷属性伤害</><Default>, 并<LightingDamage>击晕</>所有目标 %.2f 秒</>\n\n\
<Default>冷却时间:</> <Cooldown>%.2f</> <Default>秒</>\n\
<Default>法力消耗:</> <ManaCost>%.2f</> <Default>/ 秒</>\n\
		"),
			Level,
			...
			AdditionalTargetRadius, EffectiveTargetNum, Damage / .1f,
			EndDamage, DebuffDuration,
			Cooldown,
			ManaCost);
	}
...
<Warning>[此技能需要选中一个目标]</>\n\
		<Default>激活时, 对目标以及目标周围 %.0f 范围内的至多 %d 名敌人持续造成伤害, 每秒造成</> <Damage>%.1f</> <Default>点</><LightingDamage>雷属性伤害</>\n\
		<Default>在技能结束时, 对目标额外造成</> <Damage>%.1f</> <Default>点</><LightingDamage>雷属性伤害</><Default>, 并<LightingDamage>击晕</>所有目标 %.2f 秒</>\n\n\
<Default>冷却时间:</> <Cooldown>%.2f</> <Default>秒</>\n\
<Default>法力消耗:</> <ManaCost>%.2f</> <Default>/ 秒</>\n\
		"),
			Level,
