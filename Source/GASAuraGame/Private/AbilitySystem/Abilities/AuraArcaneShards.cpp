...
<SubTitle>紫水晶: 最有用的一集</>\n\
		<Default>在选取的位置生成 1 个紫水晶碎片, 击飞紫水晶碎片内的所有目标并造成至多</> <Damage>%.1f + %.1f%%物理伤害 + %.1f%%魔法伤害</> <Default>点</><ArcaneDamage>神秘属性伤害</>\n\
...
<Default>最低伤害:</> <Damage>%.1f%%最大伤害</>\n\
		...
		Damage, GetAdditionalAttributeValueByName(FName("ArcaneShards.Hit.Physical"), Level), GetAdditionalAttributeValueByName(FName("ArcaneShards.Hit.Magical"), Level),
...
<SubTitle>紫水晶: 最有用的一集</>\n\
		<Default>在选取的位置以及 %.0f 范围内的随机位置生成共 %d 个紫水晶碎片, 击飞紫水晶碎片内的所有目标并造成至多</> <Damage>%.1f + %.1f%%物理伤害 + %.1f%%魔法伤害</> <Default>点</><ArcaneDamage>神秘属性伤害</>\n\
<SubTitle>伤害从中心点的 %.0f 范围处开始衰减, 在 %.0f 范围处降至最低伤害</>\n\n\
<Default>冷却时间:</> <Cooldown>%.2f</> <Default>秒</>\n\
<Default>法力消耗:</> <ManaCost>%.2f</>\n\
<Default>最低伤害:</> <Damage>%.1f%%最大伤害</>\n\
		"),
			...
			EffectiveSpawnRadius, 1 + EffectiveAdditionalShardAmount, Damage, GetAdditionalAttributeValueByName(FName("ArcaneShards.Hit.Physical"), Level), GetAdditionalAttributeValueByName(FName("ArcaneShards.Hit.Magical"), Level),
			RadialDamageInnerRadius, RadialDamageOuterRadius,
			Cooldown,
			ManaCost,
			MinRadialDamagePercentage
